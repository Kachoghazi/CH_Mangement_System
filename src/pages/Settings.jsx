...
const Settings = ({
  ...
  const handleSaveEdit = () => {
    ...
    const updatedFees = fees.map((fee) => (fee.id === editingFee.id ? updatedFee : fee));
  ...
  const ThemePreview = ({ theme }) => {
    ...
    return (
      ...
      >
        ...
        {isActive && (
          <div style={{ marginTop: '5px', fontSize: '12px', color: '#667eea' }}>✓ Active</div>
        )}
      </div>
    );
  };
    ...
    <div style={{ padding: '20px', minHeight: 'calc(100vh - 60px)' }}>
      ...
      >
        ...
        <div style={{ opacity: 0.9, fontSize: '14px' }}>
          Academy: {systemSettings.academyName} | Currency: {systemSettings.currency} | Theme:{' '}
      ...
      >
        ...
        >
          ...
          <div
            style={{ fontSize: '28px', fontWeight: '700', marginBottom: '5px', color: '#667eea' }}
          >
            {stats.totalStudents}
          </div>
        ...
        >
          ...
          <div
            style={{ fontSize: '28px', fontWeight: '700', marginBottom: '5px', color: '#f5576c' }}
          >
            {stats.totalFeeTypes}
          </div>
          <div style={{ fontSize: '13px', color: 'var(--text-secondary)', fontWeight: '600' }}>
        ...
        >
          ...
          <div
            style={{ fontSize: '28px', fontWeight: '700', marginBottom: '5px', color: '#4facfe' }}
          >
            {stats.totalPayments}
          </div>
          <div style={{ fontSize: '13px', color: 'var(--text-secondary)', fontWeight: '600' }}>
        ...
        >
          ...
          <div
            style={{ fontSize: '28px', fontWeight: '700', marginBottom: '5px', color: '#43e97b' }}
          >
      ...
      >
        <button
          style={{
            ...
            border: 'none',
            background:
              activeTab === 'fees' ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'none',
            borderRadius: '8px',
            fontWeight: '600',
            fontSize: '14px',
            cursor: 'pointer',
            ...
            justifyContent: 'center',
            gap: '8px',
            color: activeTab === 'fees' ? 'white' : 'var(--text-primary)',
          }}
        ...
        <button
          style={{
            ...
            border: 'none',
            background:
              activeTab === 'system' ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'none',
            borderRadius: '8px',
            fontWeight: '600',
            fontSize: '14px',
            cursor: 'pointer',
            ...
            justifyContent: 'center',
            gap: '8px',
            color: activeTab === 'system' ? 'white' : 'var(--text-primary)',
          }}
        ...
        <button
          style={{
            ...
            border: 'none',
            background:
              activeTab === 'data' ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'none',
            borderRadius: '8px',
            fontWeight: '600',
            fontSize: '14px',
            cursor: 'pointer',
            ...
            justifyContent: 'center',
            gap: '8px',
            color: activeTab === 'data' ? 'white' : 'var(--text-primary)',
          }}
        ...
        <button
          style={{
            ...
            border: 'none',
            background:
              activeTab === 'danger' ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : 'none',
            borderRadius: '8px',
            fontWeight: '600',
            fontSize: '14px',
            cursor: 'pointer',
            ...
            justifyContent: 'center',
            gap: '8px',
            color: activeTab === 'danger' ? 'white' : 'var(--text-primary)',
          }}
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ display: 'flex', gap: '15px', alignItems: 'flex-end' }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                >
                  Amount ({systemSettings.currency}) *
                </label>
                <input
                  type="number"
                  placeholder="0.00"
            ...
            >
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setSettingsForm({ ...settingsForm, enableNotifications: e.target.checked })
                  }
                  style={{ display: 'none' }}
                />
                <span
                  style={{
                    ...
                    right: 0,
                    bottom: 0,
                    backgroundColor: settingsForm.enableNotifications ? '#48bb78' : '#cbd5e1',
                    transition: '.4s',
                    borderRadius: '28px',
                  }}
                >
                  <span
                    style={{
                      ...
                      transition: '.4s',
                      borderRadius: '50%',
                      transform: settingsForm.enableNotifications ? 'translateX(26px)' : 'none',
                    }}
                  ></span>
                </span>
              </div>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p style={{ margin: 0, color: '#d69e2e', fontSize: '14px' }}>
                Always backup your data before making changes. Data loss cannot be recovered.
              </p>
            </div>
          </div>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <p style={{ marginBottom: '15px', color: 'var(--text-secondary)', fontSize: '14px' }}>
              Download a complete backup of all students, fees, and payment records as a JSON file.
            </p>
            <button
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <p style={{ marginBottom: '15px', color: 'var(--text-secondary)', fontSize: '14px' }}>
              Restore data from a previous backup. This will overwrite existing data.
            </p>
            <textarea
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p style={{ margin: 0, color: '#e53e3e', fontSize: '14px' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <h4 style={{ marginBottom: '15px', color: '#e53e3e', fontSize: '16px' }}>
              Reset All Data
            </h4>
            <p style={{ marginBottom: '15px', color: 'var(--text-secondary)', fontSize: '14px' }}>
              This will delete ALL students, fees, payment records, and settings. The system will be
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <p style={{ marginBottom: '15px', color: 'var(--text-secondary)', fontSize: '14px' }}>
              Clear all data stored in your browser's local storage. This will log you out.
            </p>
            <button
              onClick={() => {
                if (
                  window.confirm(
                    'Clear ALL browser storage? This will delete everything and log you out!',
                  )
                ) {
                  localStorage.clear();
