...
const MonthWiseStudentList = ({ students = [], courses = [], systemSettings = {} }) => {
  ...
  const handleInstallmentDuringPromotion = (student) => {
    ...
    if (
      student.installmentPlan === 'installment' &&
      student.installmentMonthsList &&
      student.installmentMonthsList.length > 0
    ) {
  ...
  useEffect(() => {
    ...
    const newAdmissions = combined.filter(
      (s) => !s.admissionMonth || s.admissionMonth === '',
    ).length;
  ...
  const exportToCSV = () => {
    ...
    try {
      const monthName =
        selectedMonth === 'all'
          ? 'All Months'
          : months.find((m) => m.value === selectedMonth)?.name || selectedMonth;
      ...
      const allRows = [...metadata, headers, ...studentRows, totals];
      ...
      setTimeout(() => {
        alert(
          `✅ Successfully exported ${allStudents.length} students to CSV!\n\nFile: ${fileName}`,
        );
        setExportProgress(0);
      }, 300);
    } catch (error) {
  ...
  const handlePromotion = () => {
    ...
    if (
      promotionSource.month === promotionTarget.month &&
      promotionSource.year === promotionTarget.year
    ) {
    ...
    <div style={styles.container}>
              ...
              <div>
                <h2 style={{ margin: 0, fontSize: '22px', fontWeight: '700' }}>
                  ...
                  {promotionType === 'single'
                    ...
                    : 'Promote Students to New Month'}
                </h2>
                <p style={{ margin: '5px 0 0 0', opacity: 0.9, fontSize: '14px' }}>
                  {promotionType === 'single'
                    ? 'Move this student to a new month'
                    : 'Move selected students from one month to another'}
                </p>
              </div>
              <button
                style={{
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '12px', color: '#64748b' }}>
                        ID: {singleStudentToPromote.studentId} | Course:{' '}
                        {singleStudentToPromote.course}
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', gap: '10px' }}>
                      <select
                        ...
                        onChange={(e) =>
                          setPromotionTarget({ ...promotionTarget, month: Number(e.target.value) })
                        }
                        style={{
                          padding: '10px',
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setPromotionTarget({ ...promotionTarget, year: Number(e.target.value) })
                        }
                        style={{
                          padding: '10px',
                          border: '2px solid #86efac',
                ...
                >
                  ...
                  <div style={{ fontSize: '13px', color: '#92400e' }}>
                    <ul style={{ margin: 0, paddingLeft: '20px' }}>
                      ...
                      <li>
                        For students with installment plans, if an installment is due for the target
                        month, it will be automatically marked as paid
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        >
                          Students in {months.find((m) => m.value === promotionSource.month)?.name}{' '}
                          {promotionSource.year}
                        </h4>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        ...
                        >
                          {selectedStudentsForPromotion.length} of {studentsInSourceMonth.length}{' '}
                          selected
                        </div>
                      </div>
                    </div>
                    ...
                    {studentsInSourceMonth.length === 0 ? (
                      ...
                      >
                        ...
                        <div style={{ fontSize: '12px' }}>
                          ...
                          {months.find((m) => m.value === promotionSource.month)?.name}{' '}
                          {promotionSource.year}
                        </div>
                      </div>
                    ) : (
                      ...
                      >
                        {studentsInSourceMonth.map((student, index) => {
                          const isSelected = selectedStudentsForPromotion.includes(
                            student.studentId,
                          );
                          ...
                          return (
                            <div
                              ...
                              style={{
                                padding: '12px 15px',
                                borderBottom:
                                  index < studentsInSourceMonth.length - 1
                                    ? '1px solid #f1f5f9'
                                    : 'none',
                                  ...
                                  >
                                    ...
                                    {installmentInfo.hasInstallments && (
                                      <span style={styles.installmentBadge}>
                                        <CreditCard size={10} />
                                        Installment: {installmentInfo.paidInstallments}/
                    ...
                    {studentsInSourceMonth.length > 0 && (
                      <div
                        style={{
                          ...
                          padding: '12px 15px',
                          background:
                            selectedStudentsForPromotion.length > 0 ? '#dbeafe' : '#f1f5f9',
                          borderRadius: '8px',
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    color:
                      isPromoting || selectedStudentsForPromotion.length === 0
                        ? '#64748b'
                        : 'white',
                    border: 'none',
                    borderRadius: '8px',
                    ...
                    fontWeight: '600',
                    cursor:
                      selectedStudentsForPromotion.length === 0 || isPromoting
                        ? 'not-allowed'
                        : 'pointer',
                    display: 'flex',
                    alignItems: 'center',
      ...
      <div style={styles.filters}>
        ...
        <div style={styles.filterGroup}>
          ...
          <select
            ...
            style={{
              ...styles.select,
              borderColor: selectedYear !== 'all' ? '#3b82f6' : '#e2e8f0',
            }}
          >
        ...
        <div style={styles.filterGroup}>
          ...
          <select
            ...
            style={{
              ...styles.select,
              borderColor:
                selectedStatus !== 'all' ? getStatusInfo(selectedStatus).color : '#e2e8f0',
            }}
          >
      ...
      <div style={styles.statsCards}>
        ...
        <div
          style={{
            ...styles.statCard,
            background: getStatusInfo('Active').bg,
            borderColor: getStatusInfo('Active').color,
          }}
        >
          <div style={{ ...styles.statLabel, color: getStatusInfo('Active').color }}>Active</div>
          <div style={{ ...styles.statValue, color: getStatusInfo('Active').color }}>
            {stats.active}
          </div>
          <div style={{ fontSize: '12px', color: getStatusInfo('Active').color, opacity: 0.8 }}>
            Currently Studying
          </div>
        </div>
                  ...
                  <div style={styles.studentInfo}>
                    ...
                    <div style={styles.studentDetails}>
                      ...
                      <div style={styles.studentMeta}>
                        ...
                        <span>
                          <Book size={12} /> {student.course || 'N/A'}
                        </span>
                        <span>
                          <Phone size={12} /> {student.phone || 'N/A'}
                        </span>
                        <span>
                          <Calendar size={12} /> {formatDate(student.admissionDate)}
                        </span>
                    ...
                    <div style={styles.detailGrid}>
                      ...
                      <div style={styles.detailItem}>
                        ...
                        <div style={styles.detailValue}>
                          ...
                          <div
                            style={{
                              color: dueAmount > 0 ? '#ef4444' : '#10b981',
                              display: 'flex',
                              justifyContent: 'space-between',
                              fontWeight: '600',
                            }}
                          ...
                          {installmentInfo.hasInstallments && (
                            ...
                            >
                              <div
                                style={{ fontSize: '12px', color: '#64748b', marginBottom: '5px' }}
                              >
                                <strong>Installment Details:</strong>
                              </div>
                              <div style={{ fontSize: '11px', color: '#0369a1' }}>
                                Plan: {installmentInfo.paidInstallments} paid of{' '}
                                {installmentInfo.totalInstallments}
                                {installmentInfo.nextInstallment && (
                                  <div style={{ marginTop: '5px', color: '#92400e' }}>
                                    Next: {installmentInfo.nextInstallment.month}{' '}
                                    {installmentInfo.nextInstallment.year} -{' '}
                                    {formatCurrency(installmentInfo.installmentAmount)}
                                  </div>
                                )}
                              </div>
                            </div>
                            ...
                            if (confirmPay) {
                              ...
                              const updatedStudents = allStudents.map((s) => {
                                if (s.studentId === student.studentId) {
                                  const updatedInstallmentList = s.installmentMonthsList.map(
                                    (installment) =>
                                      `${installment.month} ${installment.year}` ===
                                      `${installmentInfo.nextInstallment.month} ${installmentInfo.nextInstallment.year}`
                                        ? {
                                            ...installment,
                                            paid: true,
